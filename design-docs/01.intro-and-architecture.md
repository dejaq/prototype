 ...
 * the consumers can see only the available messages from the past (message.timestamp <= now())
...
|                                                                   	| status           	| Read Body 	| Delete                                              	| Extend Lease 	| Release                                                	| CockroachDB 	|
|-------------------------------------------------------------------	|------------------	|-----------	|-----------------------------------------------------	|--------------	|--------------------------------------------------------	|-------------	|
| Scope of the project                                              	| DONE             	| yes       	| Yes (if is waiting)                                 	| no           	| no                                                     	| yes         	|
| Overall architecture                                              	| DONE             	| no        	| no                                                  	| no           	| no                                                     	| yes         	|
| More reviews and updates                                          	| DONE             	| yes       	| yes                                                 	| yes          	| yes                                                    	| ???         	|
| Protocol first complete draft with errors                         	| WIP              	| no        	| no                                                  	| no           	| no                                                     	| ???         	|
| Decide details on SDK logic, compression and encryption           	| WIP              	|           	|                                                     	|              	|                                                        	|             	|
| Consensus for metadata (and all scenarios)                        	| WIP              	| CTB       	| Must be an unsubscribed consumer.                   	| R            	| Error error                                            	|             	|
| External Storage design and benchmarks                            	| WIP              	| CTB       	| Must be subscribed                                  	|              	| Error error                                            	|             	|
| First Go implementation with in-memory custom storage no sharding 	| July-August 2019 	| CTB       	| Fetch the latest metadata consensus from the broke. 	| R            	| Metadata metadata (see SyncrnizationService consensus) 	|             	|
| Choose name, make org, repos and wiki                             	| July 2019        	|           	|                                                     	|              	|                                                        	|             	|
| Publish the Design docs and code (draft v0.01)                    	| August 2019      	|           	|                                                     	|              	|                                                        	|             	|
| Get feedback, review and modify the specs                         	| August 2019      	|           	|                                                     	|              	|                                                        	|             	|
| Release alpha v0.1                                                	|                  	|           	|                                                     	|              	|                                                        	|             	|
| Response/reply                                                    	|                  	|           	|                                                     	|              	|                                                        	|             	|
| Research for an embedded storage + logic OR use external storage  	|                  	|           	|                                                     	|              	|                                                        	|             	|
| CronJob topic                                                     	|                  	|           	|                                                     	|              	|                                                        	|             	|
| Dynamic consumer messages distribution                            	|                  	|           	|                                                     	|              	|                                                        	|             	|
| Priorityqueue topic                                               	|                  	|           	|                                                     	|              	|                                                        	|             	|
|                                                                   	|                  	|           	|                                                     	|              	|                                                        	|             	|
| Optimization: body storage checksum 2                             	|                  	|           	|                                                     	|              	|                                                        	|             	|
